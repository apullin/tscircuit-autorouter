...
//
// Copied from the proven hdastar port (awt-r3/native/hdastar/src/json.rs),
// minus the ryu-based serializer (write_f64/write_jval) so this crate has
// zero dependencies. Only the parser + write_json_string are kept.
...
// ---------- Minimal string serializer (JS JSON.stringify escaping) ----------
